      ...
      <div className="player-wrapper">
        ...
        <div className="one-to-one-text">
          <p>
            ...
            The Coaching space allows you to{" "}
          ...
          <p>
            ...
            <strong>potential is unlocked</strong>. For the work to take root
            you have <strong>daily practices</strong> and activities that embed
            what you’re learning into your daily life.{" "}
          </p>{" "}
          <p>
